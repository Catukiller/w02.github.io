...
// Paso 4: Función reset
const reset = () => {
    templesElement.innerHTML = "";
};

// Paso 5: Función sortBy
const sortBy = (temples) => {
    ...
    switch (filter) {
        ...
        case "older":
            ...
            displayTemples(temples.filter(temple => new Date(temple.dedicationDate) < date1950));
            break;
        case "all":
        default:
...
// Paso 6: Event Listener
document.querySelector("#sortBy").addEventListener("change", () => { sortBy(templeList) });

// Paso 7: Llamada a la función getTemples para iniciar el proceso
getTemples();
